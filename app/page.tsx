  ...
  return (
    <>
      ...
      <main className="relative min-h-screen w-full max-w-full md:h-screen md:overflow-hidden flex flex-col md:flex-none md:items-center md:justify-center overflow-x-hidden overflow-y-auto bg-[#050810]">
        ...
        <section className="w-full max-w-full px-1.5 xs:px-2.5 xs:py-3 sm:px-3 sm:py-4 md:absolute md:bottom-[2%] md:left-1/2 md:-translate-x-1/2 md:w-[88%] lg:w-[82%] xl:w-[60%] md:max-w-[min(100%,900px)] md:px-0 md:py-0">
