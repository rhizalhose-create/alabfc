const zoneConfig = {
  defensive: {
    ...
    labelClass: "absolute -left-0 top-1/2 font-bold text-xs xs:text-sm sm:text-base md:text-lg lg:text-xl uppercase tracking-widest xs:tracking-wider -translate-y-1/2 transition-all duration-300 px-1 xs:px-2 text-center leading-tight whitespace-nowrap",
