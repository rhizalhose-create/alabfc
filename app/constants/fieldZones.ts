const zoneConfig = {
  attacking: {
    ...
    overlayActive: "bg-gradient-to-b from-red-500/20 via-transparent to-transparent backdrop-brightness-125 shadow-[inset_0_0_30px_rgba(255,100,100,0.3)] border-b border-red-400/50",
    borderActive: "border-red-400/30 rounded-t-2xl",
  ...
  defensive: {
    ...
    overlayActive: "bg-gradient-to-t from-sky-500/20 via-transparent to-transparent backdrop-brightness-125 shadow-[inset_0_0_30px_rgba(0,200,255,0.3)] border-t border-sky-400/50",
    borderActive: "border-sky-400/30 rounded-b-2xl",
    labelClass: "absolute -left-0 top-1/2 font-bold text-[10px] xs:text-xs sm:text-sm md:text-base lg:text-lg uppercase tracking-widest xs:tracking-wider -translate-y-1/2 transition-all duration-300 px-1 xs:px-2 text-center leading-tight whitespace-nowrap",
