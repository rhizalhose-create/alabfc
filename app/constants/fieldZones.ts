const zoneConfig = {
  defensive: {
    ...
    labelClass: "absolute left-1/2 top-[15%] font-bold text-xs xs:text-sm sm:text-base md:text-lg lg:text-xl uppercase tracking-widest xs:tracking-wider -translate-x-1/2 transition-all duration-300 px-1 xs:px-2 text-center leading-tight",
